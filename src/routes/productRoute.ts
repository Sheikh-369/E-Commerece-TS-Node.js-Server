...
router.route("/product").post(Middleware.isLoggedI,Middleware.accessTo(Role.Admin),ProductController.createProduct)
router.route("/product/:id").patch(Middleware.isLoggedI,Middleware.accessTo(Role.Admin),ProductController.updateProduct)
